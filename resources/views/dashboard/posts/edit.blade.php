...
@section('container')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h3">Edit Post | {{ auth()->user()->name }}</h1>
    </div>
    ...
    <div class="col-lg-8">
        <form method="post" action="/dashboard/posts/{{ $post->slug }} ">
            ...
            @csrf
            <div>
                <label for="title" class="form-label mt-2">Title Post</label>
            ...
            <button type="submit" class="btn btn-primary mt-3">Submit Edit Post</button>
        </form>
    </div>
